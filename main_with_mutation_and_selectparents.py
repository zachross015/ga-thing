...
def select_parents(network1, network2, network3):
    #3 tournament selection
    #select_parents is run below where population is initialized
...
sel1 = npr.randint(0,10)
sel2 = npr.randint(0,10)
sel3 = npr.randint(0,10)

select_parents(sel1,sel2,sel3)
